...
export function LandingPage() {
  return (
    <main
      data-theme="winter"
      className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(191,219,254,0.75),transparent_28%),linear-gradient(180deg,#f7fbff_0%,#eef6fb_100%)] text-base-content"
    >
      <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8 lg:py-6">
        <header className="rounded-4xl border border-base-content/12 bg-base-100/92 p-4 shadow-[0_10px_30px_rgba(15,23,42,0.06)] backdrop-blur lg:p-5">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <nav className="flex flex-wrap items-center gap-2">
              <a href="#features" className="btn btn-ghost rounded-full">
                Features
              </a>
              <a href="#how-it-works" className="btn btn-ghost rounded-full">
                How it works
              </a>
              <a href="#offline" className="btn btn-ghost rounded-full">
                Offline sync
              </a>
              <Link to="/dashboard" className="btn btn-primary rounded-full">
                View app
              </Link>
            </nav>
          </div>
        ...
        <section className="mt-8 overflow-hidden rounded-[2.75rem] border border-slate-900/8 bg-[radial-gradient(circle_at_top_right,rgba(59,130,246,0.22),transparent_28%),linear-gradient(135deg,#171c27_0%,#1f2937_58%,#141821_100%)] px-5 py-8 text-white shadow-[0_30px_100px_rgba(15,17,21,0.18)] lg:mt-12 lg:px-8 lg:py-10">
          <div className="grid gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
            <div className="max-w-3xl">
              <div className="badge border border-white/10 bg-white/10 px-4 py-3 font-medium text-white shadow-sm">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link to="/dashboard" className="btn rounded-full border-none bg-white px-6 text-neutral shadow-lg hover:bg-white/92">
                  Preview the app
                  <ArrowRight className="size-4" />
                </Link>
                <a
                  href="#features"
                  className="btn rounded-full border border-white/18 bg-white/8 px-6 text-white hover:bg-white/14"
                >
                  Explore features
                </a>
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[2.5rem] border border-white/12 bg-white/7 p-4 backdrop-blur lg:p-5">
                <div className="rounded-4xl border border-slate-900/8 bg-white p-5 text-neutral shadow-[0_30px_80px_rgba(15,17,21,0.14)]">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-neutral/55">Product preview</p>
                      <h2 className="mt-1 text-2xl font-semibold text-neutral">
                        A focused app experience after sign in
                      </h2>
                    </div>
                  ...
                  <div className="mt-5 grid gap-4">
                    ...
                    <div className="grid gap-3 sm:grid-cols-3">
                      <div className="rounded-3xl border border-neutral/10 bg-slate-50 p-4 shadow-sm">
                        <ReceiptText className="size-4 text-primary" />
                        <p className="mt-3 text-sm font-semibold text-neutral">Item-level bills</p>
                        <p className="mt-1 text-xs leading-6 text-neutral/60">
                          One total or multiple shared items
                        </p>
                      </div>
                      <div className="rounded-3xl border border-neutral/10 bg-slate-50 p-4 shadow-sm">
                        <Users className="size-4 text-primary" />
                        <p className="mt-3 text-sm font-semibold text-neutral">Shared groups</p>
                        <p className="mt-1 text-xs leading-6 text-neutral/60">
                      ...
                      <div className="rounded-3xl border border-neutral/10 bg-slate-50 p-4 shadow-sm">
                        ...
                        <p className="mt-3 text-sm font-semibold text-neutral">Offline-safe storage</p>
                        <p className="mt-1 text-xs leading-6 text-neutral/60">
        ...
        <section className="mt-8 rounded-4xl border border-base-content/10 bg-white px-5 py-4 shadow-[0_10px_30px_rgba(15,23,42,0.05)] lg:mt-12">
          <div className="grid gap-4 text-sm font-medium text-base-content/76 md:grid-cols-4">
        ...
        <section id="features" className="mt-10 lg:mt-16">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-2 text-3xl font-semibold tracking-tight text-base-content sm:text-4xl lg:text-5xl">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {featureCards.map((feature) => {
              ...
              return (
                <article
                  key={feature.title}
                  className="rounded-4xl border border-base-content/10 bg-base-100 p-6 shadow-[0_12px_30px_rgba(15,23,42,0.05)]"
                >
                  <div className="w-fit rounded-2xl bg-primary/14 p-3 text-primary">
                    <Icon className="size-5" />
                  </div>
                  <h3 className="mt-5 text-xl font-semibold text-base-content">{feature.title}</h3>
        ...
        <section id="how-it-works" className="mt-10 lg:mt-16">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-2 text-3xl font-semibold tracking-tight text-base-content sm:text-4xl">
          ...
          <div className="mt-8 grid gap-5 lg:grid-cols-3">
            {howItWorks.map((step, index) => (
              <div
                ...
                className="rounded-4xl border border-base-content/10 bg-base-100 p-6 shadow-[0_12px_30px_rgba(15,23,42,0.05)]"
              >
                <div className="flex size-10 items-center justify-center rounded-full bg-primary text-primary-content text-sm font-semibold">
                  {index + 1}
                </div>
                <h3 className="mt-5 text-xl font-semibold text-base-content">{step.title}</h3>
                <p className="mt-3 text-sm leading-7 text-base-content/75">{step.description}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        >
          <div>
            <p className="text-sm font-medium text-primary">Offline-first sync</p>
            <h2 className="mt-2 text-3xl font-semibold tracking-tight text-base-content sm:text-4xl lg:text-5xl">
            ...
            <div className="mt-6 space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-base-content">Local persistence by default</p>
                  <p className="mt-1 text-sm leading-7 text-base-content/75">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-base-content">Cloud sync as the backup layer</p>
                  <p className="mt-1 text-sm leading-7 text-base-content/75">
          ...
          <div className="rounded-[2.5rem] border border-base-content/10 bg-base-100 p-6 shadow-[0_14px_40px_rgba(15,23,42,0.06)] lg:p-8">
            <div className="rounded-4xl border border-base-content/8 bg-slate-50 p-5">
              <p className="text-sm font-medium text-base-content/60">Why this matters</p>
              ...
              <div className="mt-5 space-y-3">
                <div className="rounded-3xl border border-base-content/8 bg-white p-4 shadow-sm">
                  <p className="text-sm font-semibold text-base-content">Offline-safe logging</p>
                  <p className="mt-1 text-xs leading-6 text-base-content/70">
                    Add expenses anytime without depending on network requests.
                  </p>
                </div>
                <div className="rounded-3xl border border-base-content/8 bg-white p-4 shadow-sm">
                  <p className="text-sm font-semibold text-base-content">Automatic sync later</p>
                  <p className="mt-1 text-xs leading-6 text-base-content/70">
        ...
        <section className="mt-10 lg:mt-16">
          ...
          <div className="mt-8 grid gap-5 lg:grid-cols-3">
            {useCases.map((useCase) => (
              <article
                key={useCase.title}
                className="rounded-4xl border border-base-content/8 bg-base-100 p-6 shadow-sm"
              >
                <h3 className="text-xl font-semibold text-base-content">{useCase.title}</h3>
                <p className="mt-3 text-sm leading-7 text-base-content/75">{useCase.description}</p>
              </article>
            ))}
          </div>
        </section>
        ...
        <section className="mt-10 lg:mt-16">
          <div className="rounded-[2.5rem] border border-slate-900/6 bg-[linear-gradient(135deg,#1b2332_0%,#202938_55%,#18202d_100%)] p-6 text-neutral-content shadow-[0_20px_70px_rgba(15,23,42,0.12)] lg:p-10">
            <div className="grid gap-5 md:grid-cols-3">
              <div className="rounded-3xl border border-white/12 bg-white/12 p-5 shadow-sm">
                <Users className="size-5 text-neutral-content" />
                <p className="mt-4 text-lg font-semibold">Invite members</p>
                <p className="mt-2 text-sm leading-7 text-neutral-content/75">
                  Create groups and add other users when you are ready to collaborate online.
                </p>
              </div>
              <div className="rounded-3xl border border-white/12 bg-white/12 p-5 shadow-sm">
                <ReceiptText className="size-5 text-neutral-content" />
              ...
              <div className="rounded-3xl border border-white/12 bg-white/12 p-5 shadow-sm">
                <CreditCard className="size-5 text-neutral-content" />
        ...
        <section className="mt-10 pb-8 lg:mt-16">
          <div className="rounded-4xl border border-base-content/10 bg-base-100 p-8 shadow-[0_14px_40px_rgba(15,23,42,0.06)] lg:p-10">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div className="max-w-2xl">
                <p className="text-sm font-medium text-primary">Get started</p>
                <h2 className="mt-2 text-3xl font-semibold tracking-tight text-base-content sm:text-4xl">
                  A normal product landing page on the outside, a detailed bill-splitting app on the inside.
                </h2>
                <p className="mt-4 text-base leading-8 text-base-content/75">
                  The homepage now focuses on explaining what Kwenta is, while the dashboard stays
                  separate as the actual app experience.
                </p>
              </div>

              <div className="flex flex-wrap gap-3">
                <Link to="/dashboard" className="btn btn-primary rounded-full px-6">
                  Open dashboard
                </Link>
              </div>
            </div>
